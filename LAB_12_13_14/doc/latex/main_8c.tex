...
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{main_8c_a7829e7c5c37ea8a78e879aa2028dfb21}{S\+A\+M\+P\+\_\+\+P\+E\+R\+I\+O\+D\+\_\+\+MS}}~250
\item 
...
\item 
\#define \mbox{\hyperlink{main_8c_a91585133db96440dc6b21718535c5e6b}{thread\+\_\+sampling\+\_\+prio}}~2
\item 
\#define \mbox{\hyperlink{main_8c_a5620c118b737fef676e57cb77cc36d64}{thread\+\_\+processing\+\_\+prio}}~2
\item 
\#define \mbox{\hyperlink{main_8c_ad74d90eda75d0ad6e39cbd57bd69f194}{thread\+\_\+actuation\+\_\+prio}}~2
\item 
\#define \mbox{\hyperlink{main_8c_a56cc10cd6ec30f18b9192d5ca60b93fa}{thread\+\_\+calendar\+Timer\+\_\+prio}}~3
\item 
...
\item 
\mbox{\hyperlink{main_8c_a6cebfc31708d6ea63724c280e835d29f}{K\+\_\+\+T\+H\+R\+E\+A\+D\+\_\+\+S\+T\+A\+C\+K\+\_\+\+D\+E\+F\+I\+NE}} (thread\+\_\+calendar\+Timer\+\_\+stack, \mbox{\hyperlink{main_8c_a6423a880df59733d2d9b509c7718d3a9}{S\+T\+A\+C\+K\+\_\+\+S\+I\+ZE}})
\item 
...
void \mbox{\hyperlink{main_8c_ae8fdb30eef0b90b0ec83c0baabe093c7}{thread\+\_\+calendar\+Timer}} (void $\ast$argA, void $\ast$argB, void $\ast$argC)
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{structCalendar}{Calendar}} Timer thread to implement a calendar. \end{DoxyCompactList}\item 
...
\item 
struct k\+\_\+thread \mbox{\hyperlink{main_8c_a2c3602187ab60325c824e8da89f8781f}{thread\+\_\+calendar\+Timer\+\_\+data}}
\item 
...
\item 
k\+\_\+tid\+\_\+t \mbox{\hyperlink{main_8c_ab85740b770c20e30f04586b75eb48f14}{thread\+\_\+calendar\+Timer\+\_\+tid}}
\item 
...
\item 
int \mbox{\hyperlink{main_8c_a299ec0c42ccc5a2d79d1739428ac3210}{intensity}} = 0
\item 
...
\item 
struct k\+\_\+sem \mbox{\hyperlink{main_8c_a0add50012e50d26880c6220a43851426}{sem\+\_\+mut}}
\end{DoxyCompactItemize}
...
{\footnotesize\ttfamily \#define S\+A\+M\+P\+\_\+\+P\+E\+R\+I\+O\+D\+\_\+\+MS~250}
...
{\footnotesize\ttfamily \#define thread\+\_\+actuation\+\_\+prio~2}

Scheduling priority of actuation thread \mbox{\Hypertarget{main_8c_a56cc10cd6ec30f18b9192d5ca60b93fa}\label{main_8c_a56cc10cd6ec30f18b9192d5ca60b93fa}} 
\index{main.c@{main.c}!thread\_calendarTimer\_prio@{thread\_calendarTimer\_prio}}
\index{thread\_calendarTimer\_prio@{thread\_calendarTimer\_prio}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{thread\_calendarTimer\_prio}{thread\_calendarTimer\_prio}}
{\footnotesize\ttfamily \#define thread\+\_\+calendar\+Timer\+\_\+prio~3}

Scheduling priority of calendar timer thread \mbox{\Hypertarget{main_8c_a8c3412660bfe383842b2e5cfd2311b7b}\label{main_8c_a8c3412660bfe383842b2e5cfd2311b7b}} 
...
{\footnotesize\ttfamily \#define thread\+\_\+processing\+\_\+prio~2}
...
{\footnotesize\ttfamily \#define thread\+\_\+sampling\+\_\+prio~2}

Scheduling priority of sampling thread \mbox{\Hypertarget{main_8c_ad6e9c4cab12b06864c5162252ca67014}\label{main_8c_ad6e9c4cab12b06864c5162252ca67014}} 
...
\mbox{\hyperlink{structCalendar}{Calendar}} Timer thread period (ms) -\/ 1 minute 
...
Create actuation thread stack space \mbox{\Hypertarget{main_8c_a6cebfc31708d6ea63724c280e835d29f}\label{main_8c_a6cebfc31708d6ea63724c280e835d29f}} 
\index{main.c@{main.c}!K\_THREAD\_STACK\_DEFINE@{K\_THREAD\_STACK\_DEFINE}}
\index{K\_THREAD\_STACK\_DEFINE@{K\_THREAD\_STACK\_DEFINE}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{K\_THREAD\_STACK\_DEFINE()}{K\_THREAD\_STACK\_DEFINE()}\hspace{0.1cm}{\footnotesize\ttfamily [2/5]}}
{\footnotesize\ttfamily K\+\_\+\+T\+H\+R\+E\+A\+D\+\_\+\+S\+T\+A\+C\+K\+\_\+\+D\+E\+F\+I\+NE (\begin{DoxyParamCaption}\item[{thread\+\_\+calendar\+Timer\+\_\+stack}]{,  }\item[{\mbox{\hyperlink{main_8c_a6423a880df59733d2d9b509c7718d3a9}{S\+T\+A\+C\+K\+\_\+\+S\+I\+ZE}}}]{ }\end{DoxyParamCaption})}

Create calendar timer thread stack space \mbox{\Hypertarget{main_8c_a74e081acfd5bb89595459f375532975f}\label{main_8c_a74e081acfd5bb89595459f375532975f}} 
\index{main.c@{main.c}!K\_THREAD\_STACK\_DEFINE@{K\_THREAD\_STACK\_DEFINE}}
\index{K\_THREAD\_STACK\_DEFINE@{K\_THREAD\_STACK\_DEFINE}!main.c@{main.c}}
...
This thread implements the task of actuation, it\textquotesingle{}s triggered by the change of the required light intensity (buttons 3 or 4) on Manual mode or by the end of the processing thread when on Automatic mode. It computes and updates the pulse width of the pwm signal from the intensity value (when on Manual mode) or from the dutycycle value (when on Automatic mode). It\textquotesingle{}s a sporadic thread triggered by the press of button 3 or button 4 or by the end of processing (processing thread), based on the operation mode. \mbox{\Hypertarget{main_8c_ae8fdb30eef0b90b0ec83c0baabe093c7}\label{main_8c_ae8fdb30eef0b90b0ec83c0baabe093c7}} 
\index{main.c@{main.c}!thread\_calendarTimer@{thread\_calendarTimer}}
\index{thread\_calendarTimer@{thread\_calendarTimer}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{thread\_calendarTimer()}{thread\_calendarTimer()}}
{\footnotesize\ttfamily void thread\+\_\+calendar\+Timer (\begin{DoxyParamCaption}\item[{void $\ast$}]{argA,  }\item[{void $\ast$}]{argB,  }\item[{void $\ast$}]{argC }\end{DoxyParamCaption})}



\mbox{\hyperlink{structCalendar}{Calendar}} Timer thread to implement a calendar. 

This thread is a periodic thread with period 1 minute (T\+I\+M\+E\+R\+\_\+\+P\+E\+R\+I\+O\+D\+\_\+\+MS), to update the day, hour and minutes \mbox{\Hypertarget{main_8c_a570350429544cf99b11c32e1f6bf0b5a}\label{main_8c_a570350429544cf99b11c32e1f6bf0b5a}} 
...
{\footnotesize\ttfamily int intensity = 0}
...
Semaphore to synch sample and actuation tasks (signals end of sampling) \mbox{\Hypertarget{main_8c_a0add50012e50d26880c6220a43851426}\label{main_8c_a0add50012e50d26880c6220a43851426}} 
\index{main.c@{main.c}!sem\_mut@{sem\_mut}}
\index{sem\_mut@{sem\_mut}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{sem\_mut}{sem\_mut}}
{\footnotesize\ttfamily struct k\+\_\+sem sem\+\_\+mut}

Semaphore to mutual exclusion on calendar \mbox{\Hypertarget{main_8c_a9a0bf1249db244ace268c06987aa8bc3}\label{main_8c_a9a0bf1249db244ace268c06987aa8bc3}} 
...
Actuation thread task ID \mbox{\Hypertarget{main_8c_a2c3602187ab60325c824e8da89f8781f}\label{main_8c_a2c3602187ab60325c824e8da89f8781f}} 
\index{main.c@{main.c}!thread\_calendarTimer\_data@{thread\_calendarTimer\_data}}
\index{thread\_calendarTimer\_data@{thread\_calendarTimer\_data}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{thread\_calendarTimer\_data}{thread\_calendarTimer\_data}}
{\footnotesize\ttfamily struct k\+\_\+thread thread\+\_\+calendar\+Timer\+\_\+data}

\mbox{\hyperlink{structCalendar}{Calendar}} Timer thread data \mbox{\Hypertarget{main_8c_ab85740b770c20e30f04586b75eb48f14}\label{main_8c_ab85740b770c20e30f04586b75eb48f14}} 
\index{main.c@{main.c}!thread\_calendarTimer\_tid@{thread\_calendarTimer\_tid}}
\index{thread\_calendarTimer\_tid@{thread\_calendarTimer\_tid}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{thread\_calendarTimer\_tid}{thread\_calendarTimer\_tid}}
{\footnotesize\ttfamily k\+\_\+tid\+\_\+t thread\+\_\+calendar\+Timer\+\_\+tid}

\mbox{\hyperlink{structCalendar}{Calendar}} Timer thread task ID \mbox{\Hypertarget{main_8c_af6d2603321c94cea6aaf2350aabf3831}\label{main_8c_af6d2603321c94cea6aaf2350aabf3831}} 
